...
public sealed partial class OverlayRenderer {
    ...
    private const uint CurrencyItemGrandCompanySeals = 20;
    private const uint CurrencyItemYellowCrafterScrip = 25199;
    private const uint CurrencyItemPurpleCrafterScrip = 33913;
    private const uint CurrencyItemYellowGathererScrip = 25200;
    private const uint CurrencyItemPurpleGathererScrip = 33914;
    private const uint CurrencyItemSkybuildersScrip = 28063;
    private const uint CurrencyItemOrangeCrafterScrip = 41784;
    private const uint CurrencyItemOrangeGathererScrip = 41785;
    private const uint CurrencyItemTrophyCrystals = 36656;
